...
func TestWebhookGet(t *testing.T) {
	...
	_, err := client.Webhooks.Get(context.TODO(), "wh_abc123def456")
	if err != nil {
		var apierr *blooio.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestWebhookUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Webhooks.Update(
		context.TODO(),
		"wh_abc123def456",
		blooio.WebhookUpdateParams{
			Deprecate:   blooio.Bool(true),
			ValidUntil:  blooio.Int(0),
			WebhookType: blooio.WebhookUpdateParamsWebhookTypeMessage,
		},
	)
	if err != nil {
		var apierr *blooio.Error
...
func TestWebhookDelete(t *testing.T) {
	...
	_, err := client.Webhooks.Delete(context.TODO(), "wh_abc123def456")
	if err != nil {
		var apierr *blooio.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
