...
func TestPhoneNumberBatchNew(t *testing.T) {
	...
	_, err := client.PhoneNumbers.BatchNew(context.TODO(), blooio.PhoneNumberBatchNewParams{
		Numbers: []string{"+12125551234", "+14155551234", "+18582849901"},
	})
	if err != nil {
